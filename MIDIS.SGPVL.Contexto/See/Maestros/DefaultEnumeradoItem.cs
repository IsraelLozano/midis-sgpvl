    ...
    public class DefaultEnumeradoItem
    {
        ...
        private async Task CreateVLEnumItem()
        {
            var listaItem = new List<VLEnumItem>
            {
                ...
                new VLEnumItem { iIdEnumerado = (int)EnumeradoCabecera.TIPO_DOCUMENTO, vDescripcion = "R.U.C", bActivo = true },
                ...
                //TIPO_RESOLUCION = 10,
                new VLEnumItem { iIdEnumerado = (int)EnumeradoCabecera.TIPO_RESOLUCION, vDescripcion = "RESOLUCION ALCALDIA", bActivo = true },
                new VLEnumItem { iIdEnumerado = (int)EnumeradoCabecera.TIPO_RESOLUCION, vDescripcion = "RESOLUCION DISTRITAL", bActivo = true },
                new VLEnumItem { iIdEnumerado = (int)EnumeradoCabecera.TIPO_RESOLUCION, vDescripcion = "RESOLUCION GERENCIAL", bActivo = true },
                new VLEnumItem { iIdEnumerado = (int)EnumeradoCabecera.TIPO_RESOLUCION, vDescripcion = "RESOLUCION PROVINCIAL", bActivo = true },
                //TIPO_CARGOS = 11,
